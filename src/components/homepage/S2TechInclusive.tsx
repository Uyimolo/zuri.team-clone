...
const S2TechInclusive = () => {
  return (
    <section className='bg-maroon pt-1 md:pt-0 md:relative'>
      <img src={dividerPattern} alt='' className='md:-top-3 md:absolute md:w-full ' />
      <GridLayout1 className='py-20 md:py-[8vw] md:grid-cols-[1fr,43%] items-center'>
        <div className='w-full'>
          <img src={visionCard} alt='' className='w-full' />
        </div>
        {/* ---text--- */}
        <SectionTextLayout buttonText='Get Started' paragraphClassName='text-snow' headingClassName='text-snow' sectionText={S2TechInclusiveTextData} />
      </GridLayout1>
    </section>
  );
};
